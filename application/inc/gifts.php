...
foreach($sql_ as $row){
	$gifts .= <<<HTML
<div style="float:left;width: 150px;height:150px;text-align:center;margin-bottom:45px;margin-top: 25px;">
...
<input type="text"  class="inpu" value="{$row['category']}" />
<select id="category{$row['gid']}" value="{$row['category']}" class="" style="width: 130;height:21">
<option  value="0">Разные</option>
<option [SELECTED]SELECTED[/SELECTED] value="1">Дружба</option>
...
<select name="category" class="" style="width: 130;height:21">
<option value="0">Разные</option>
<option value="1">Дружба</option>
<option value="2">День рождение</option>
<option value="3">Романтика</option>
</select>
<div class="mgcler"></div>
