...
if($sql_){
	...
	foreach($sql_ as $row){
		...
		$res .= <<<HTML
<div style="float:left;padding:5px;width:160px;text-align:center;border-bottom:1px dashed #ddd"><a href="/id{$row['user_id']}" target="_blank">{$row['user_search_pref']}</a></div>
