...
foreach($sql_ as $row){
	...
	$users .= <<<HTML
<div style="background:#fff;float:left;padding:5px;width:100px;text-align:center;"><a href="/id{$row['auser_id']}" target="_blank">{$row['user_name']}</a></div>
...
<input type="submit" value="Выполнить" class="inp" />
</div>
</form>
<div class="clr"></div>
HTML;
