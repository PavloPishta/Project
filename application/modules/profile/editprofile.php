...
if($logged){
	...
	switch($act){
		...
		case "load_photo":
			NoAjaxQuery();
			$tpl->load_template('load_photo.html');
			$tpl->compile('content');
			AjaxTpl();
			die();
		break;
		...
		case "contact":
			$user_fm_wrap_bar = $lang['editmyprofile'].' &raquo; '.$lang['editmyprofile_contact'];
			$tpl->load_template('editprofile.html');
		...
		case "interests":
			$user_fm_wrap_bar = $lang['editmyprofile'].' &raquo; '.$lang['editmyprofile_interests'];
			$tpl->load_template('editprofile.html');
		...
		case "all":
			$user_fm_wrap_bar = $lang['editmyprofile'].' &raquo; Другое';
			$tpl->load_template('editprofile.html');
		...
		case "miniature":
			...
			if($row['user_photo']){
				...
				$tpl->load_template('miniature/main.html');
		...
		default:
			...
			$user_fm_wrap_bar = $lang['editmyprofile'].' &raquo; '.$lang['editmyprofile_genereal'];
