...
if($logged){
	...
	if(!$row['cnt']){
		...
		for($ai = 0; $ai < sizeof($arr_answe_list); $ai++){
			...
			$result .= "<div class=\"wall_vote_oneanswe cursor_default\">{$arr_answe_list[$ai]}<br /><div class=\"wall_vote_proc fl_l\"><div class=\"wall_vote_proc_bg\" style=\"width:".intval($proc)."%\"></div><div style=\"margin-top:-21px\">{$num}</div></div><div class=\"fl_l\" style=\"margin: 3px 0;\"><b>{$proc}%</b></div></div><div class=\"clear\"></div>";
